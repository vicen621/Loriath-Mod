package io.github.vicen621.loriath.render.accessory.renderer;
...
public class GloveAccessoryRenderer implements TrinketRenderer {
    ...
    public GloveAccessoryRenderer(String defaultTexturePath, String slimTexturePath, ArmsModel defaultModel, ArmsModel slimModel) {
        this.defaultTexture = Loriath.id(String.format("textures/entity/accessory/%s.png", defaultTexturePath));
        this.slimTexture = Loriath.id(String.format("textures/entity/accessory/%s.png", slimTexturePath));
