...
public class ModSoundEvents {
    ...
    public static final SoundEvent BOX_OPEN = register("item.mistery_box.open");
    public static final SoundEvent LEGENDARY_BOX_OPEN = register("item.mistery_box.open_legendary");
    public static final SoundEvent BOX_SWITCH = register("item.mistery_box.switch");
    public static final SoundEvent BOX_SWITCH_PLUS = register("item.mistery_box.switch_plus");
    public static final SoundEvent BOX_THEME = register("item.mistery_box.theme");
